...
public class EasyExcelUtil
{
    ...
    public static final int  PER_SIZE = 100000;
    /**
     ...
     * @return
     */
    public static com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory writeWithSheets(OutputStream outputStream){
        com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory excelWriter = new com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory(outputStream);
        return excelWriter;
    }
     ...
     * @return
     */
    public static com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory writeWithSheets(File file){
        com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory excelWriter = new com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory(file);
        return excelWriter;
    }
     ...
     * @return
     */
    public static com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory writeWithSheets(String filePath){
        com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory excelWriter = new com.pactera.oozieAPI.json2sql.utils.EasyExcelWriterFactory(filePath);
        return excelWriter;
    }
